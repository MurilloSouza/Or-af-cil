       ...
       <div className="flex flex-wrap justify-between items-center gap-4">
        ...
        {isAddingGroup ? (
            ...
            <div className="flex items-center gap-2">
               ...
               <button onClick={() => setIsAddingGroup(true)} className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-3 rounded-lg text-sm" title={t('calculator.addGroup.button')}>+</button>
